...
let num2 = '10';
num2 = +num2; // 문자 앞에 부호 붙이는거
num2 = num2 * 1;
num2 = parseInt('100');



// 단축 평가 : || : 모든 비교 연산자 중에 하나라도 참이면 참 -> 한개가 참이면 나머지 비교 x 건너뛴다
//            && : 모든 비교 연산자 중에 하나라도 거짓이면 거짓 -> 한개가 거짓이면 나머지 비교 x 건너뛴다

console.log(true || '신기훈');
console.log(false || '신기훈');

console.log(true && '신기훈');
console.log(false && '신기훈');

console.log(true && false && '신기훈');
console.log(true || false || '신기훈');