...
console.log(printName.call(cat)); // 원래는 최상위 객체의 주소값인데 -> this를 cat의 주소값으로 변경 후 실행
console.log(printName.apply({ name: '신기훈' }));
...
// bind() => 내가 원할때 실행한다 : this만 세팅해놓음

const dog = {
  name: '멍뭉이'
}
console.log(printName.bind(dog)); // => [Function: bound printName]
